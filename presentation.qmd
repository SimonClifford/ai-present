...
::: {.notes}
The code has various scripts that fire on particular XNAT triggers, detailed in next slide.
...
The Docker container holds a Debian Stretch^2^ image with a Matlab runtime and SPM12^3^.
